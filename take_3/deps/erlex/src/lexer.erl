-file("/usr/local/Cellar/erlang/22.2.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/22.2.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(43, [43|Ics], Line, Tlen, Action, Alen) ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [42|Ics], Line, Tlen, Action, Alen) ->
...
yystate(43, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(41, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 38 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(36, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 63, C =< 90 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 96, C =< 101 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 122 ->
    yystate(45, Ics, Line, Tlen+1, Action, Alen);
...
yystate(41, [10|Ics], Line, Tlen, _, _) ->
    yystate(41, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(18, Ics, Line, Tlen, _, _) ->
    {18,Tlen,Ics,Line};
yystate(17, [119|Ics], Line, Tlen, _, _) ->
...
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 40 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
-file("/usr/local/Cellar/erlang/22.2.1/lib/erlang/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
